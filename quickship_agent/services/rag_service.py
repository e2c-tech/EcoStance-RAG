...
Handles knowledge base search and question answering
"""
...
def create_rag_chain(collection_name: str):
    ...
    qa_prompt = ChatPromptTemplate.from_messages(
        [
            ("human", """You are a helpful assistant. Based on the company documents provided in the context below, answer the user's question.
...
- If you can find information related to the question in the documents, provide a clear answer
- If the documents don't contain information to answer the question, say "I don't know"
...
Answer:"""),
    ...
    def retrieve_and_format(inputs):
        ...
        logger.info(f"Context being passed to LLM: {formatted_context[:200]}...")
...
def execute_query(collection_name: str, query: str, chat_history: list = None) -> str:
    ...
    logger.info(f"Retrieved Context: {formatted_context[:200]}...")
